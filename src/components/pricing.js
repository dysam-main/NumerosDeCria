...
Pricing.defaultProps = {
  ...
  plan3Action: 'Download Now',
  plan1Feature2: 'Easy-to-use templates for cost evaluation',
  plan1Yearly: '$99.99',
  plan3Yearly1: 'or $49 monthly',
  plan3Feature11: 'Feature text goes here',
  plan3Feature3: 'Interactive graphs and charts for data visualization',
  ...
  plan3Feature2: 'Comprehensive tools for financial planning',
  ...
  plan2Feature2: 'Advanced templates for in-depth analysis',
  plan1Action1: 'Get started',
  plan3Feature5: 'Feature text goes here',
  plan2Feature3: 'Customizable fields for specific operations',
  plan3: 'Enterprise plan',
  content1: 'Choose the perfect plan for you',
  plan1Feature11: 'Feature text goes here',
  heading1: 'Pricing plan',
  plan2Action: 'Download Now',
  plan2Yearly: '$199.99',
  plan1Feature3: 'Detailed instructions for accurate calculations',
  plan1Price: '$9.99',
  plan1Price1: '$200/yr',
  plan1Feature31: 'Feature text goes here',
  plan2Feature1: 'Livestock production cost worksheets',
  plan2: 'Business plan',
  plan3Feature1: 'Livestock production cost worksheets',
  plan11: 'Basic plan',
  plan1Yearly1: 'or $20 monthly',
  plan31: 'Enterprise plan',
  plan1Action: 'Download Now',
  plan1Feature1: 'Livestock production cost worksheets',
}
